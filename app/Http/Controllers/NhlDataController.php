...
class NhlDataController extends Controller
{
    // Output an "email" formatted spread
    public function emailFormatData() {
        
        // Collect the data
        $dataCollector  = new ScoresOddsScraper('nhl');
        ...
        $format = new DailyLinesEmail($data,'nhl');
    ...
    public function emailFormatRoundball() {
        ...
        // Collect the data
        $dataCollector  = new CoversComScraper('nfl');
        ...
        // Create the email format
        $format = new RoundballEmail($data,'nfl');
        $email  = $format->create_email_text();
        return $email;
    }
