...
class NcaafbController extends Controller
{
    // Output an "email" formatted spread
    public function emailFormatData() {
        
        // Collect the data
        $dataCollector  = new ScoresOddsScraper('fbc');
        ...
        $format = new DailyLinesEmail($data,'fbc');
    ...
    public function emailFormatRoundball() {
        ...
        // Collect the data
        $dataCollector  = new CoversComScraper('fbc');
        ...
        // Create the email format
        $format = new RoundballEmail($data,'fbc');
        $email  = $format->create_email_text();
        return $email;
    }
